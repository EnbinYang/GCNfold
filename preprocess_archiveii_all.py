...
# rna_type = ['RNaseP', '5s', 'tmRNA', 'tRNA', 'telomerase', '16s']
# rna_type = ['5s', '16s', 'grp1', 'RNaseP', 'srp', 'telomerase', 'tmRNA', 'tRNA']
# rna_type = ['grp2', '23s']
# rna_type = ['telomerase']
# rna_type = ['5s', '16s']

data_dir = os.getcwd()  # /content/drive/MyDrive/GCNfold
datapath = os.path.join(data_dir, 'data/raw_data/gcn_plot_data')
seed = 0
